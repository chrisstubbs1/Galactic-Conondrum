...
public class Weapon : MonoBehaviour
{
    ...
    public void Fire()
    {
        ...
        switch (type)
        {
            ...
            case WeaponType.missile:
                p = MakeProjectile();
                lastShot += Random.Range(0,.4f);
                p.GetComponent<Rigidbody>().velocity = new Vector3(Random.Range(-.5f,.5f), 0.9f, 0) * def.velocity;
                break;
    ...
    public Projectile MakeProjectile()
    {
        ...
        {
            go.transform.position = collar.transform.position + new Vector3(0.0f, 50f, 0.0f);
